...
test('Criação, edição e exclusão de centro de custos', async ({ page }) => {
    await page.login.loginIn()
    await page.components.setupDialogListener()

    //Central de Finanças > Cadastros > Centro de Custos
    await page.components.navigateSidebarMenu('1','custo')
